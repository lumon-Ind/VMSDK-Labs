...
<Dsl xmlns:dm0="http://schemas.microsoft.com/VisualStudio/2008/DslTools/Core" dslVersion="1.0.0.0" Id="1ed97869-b217-4378-a1d6-2d54dd972205" Description="Description for Company.LanguageSm.LanguageSm" Name="LanguageSm" DisplayName="LanguageSm" Namespace="Company.LanguageSm" ProductName="LanguageSm" CompanyName="Company" PackageGuid="6a50683e-071f-4949-99ac-ca49182e8818" PackageNamespace="Company.LanguageSm" xmlns="http://schemas.microsoft.com/VisualStudio/2005/DslTools/DslDefinitionModel">
  <Classes>
    <DomainClass Id="3589a8b7-8b50-467f-a80b-5be5410469ea" Description="The root in which all other elements are embedded. Appears as a diagram." Name="StateMachine" DisplayName="State Machine" Namespace="Company.LanguageSm">
      <Properties>
        <DomainProperty Id="71930c1b-cf83-4a03-893d-1223c9927559" Description="Description for Company.LanguageSm.StateMachine.Name" Name="Name" DisplayName="Name">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
        <DomainProperty Id="ee323740-3754-4a55-b55e-46568ec7bb35" Description="Description for Company.LanguageSm.StateMachine.Comment" Name="Comment" DisplayName="Comment">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
    ...
    <DomainClass Id="ee3efc0d-4fda-4fba-9fb7-759fc0a33908" Description="Description for Company.LanguageSm.Action" Name="Action" DisplayName="Action" Namespace="Company.LanguageSm">
      <Properties>
        <DomainProperty Id="8a275c0e-782d-420c-8729-c932b5e4b74e" Description="Description for Company.LanguageSm.Action.Label" Name="Label" DisplayName="Label" IsElementName="true">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
  ...
  <Relationships>
    <DomainRelationship Id="07d93d21-a85a-401b-be31-d75bea95b093" Description="Transition from one state to another" Name="Transition" DisplayName="Transition" Namespace="Company.LanguageSm">
      <Properties>
        <DomainProperty Id="9852150d-387a-4d78-acfb-7db865ecec5e" Description="Description for Company.LanguageSm.Transition.Event" Name="Event" DisplayName="Event" Category="Transition">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
        <DomainProperty Id="7333987d-5638-4d54-9f39-2b837e33dc31" Description="Description for Company.LanguageSm.Transition.Condition" Name="Condition" DisplayName="Condition" Category="Transition">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
        <DomainProperty Id="7b8d5325-9814-4fd5-be33-eba4b9df6220" Description="Description for Company.LanguageSm.Transition.Action" Name="Action" DisplayName="Action" Category="Transition">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
        <DomainProperty Id="80d3470f-c796-4611-a70d-1668fd911457" Description="Description for Company.LanguageSm.Transition.Label" Name="Label" DisplayName="Label" Category="Transition">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
    ...
    <DomainRelationship Id="82b7f08f-cbaa-4c1d-8e58-3bd9527208ec" Description="Description for Company.LanguageSm.StateMachineHasOneInitialState" Name="StateMachineHasOneInitialState" DisplayName="State Machine Has One Initial State" Namespace="Company.LanguageSm">
      <Source>
        <DomainRole Id="1311b49c-3016-4375-ba39-afc9c2a19dc6" Description="Description for Company.LanguageSm.StateMachineHasOneInitialState.StateMachine" Name="StateMachine" DisplayName="State Machine" PropertyName="InitialState" Multiplicity="One" PropertyDisplayName="Initial State">
          <RolePlayer>
      ...
      <Target>
        <DomainRole Id="22112cbb-f10a-4b0a-af18-07eb17a29da6" Description="Description for Company.LanguageSm.StateMachineHasOneInitialState.State" Name="State" DisplayName="State" PropertyName="StateMachine" Multiplicity="ZeroOne" IsPropertyGenerator="false" PropertySetterAccessModifier="Private" IsPropertyUIReadOnly="true" PropertyDisplayName="State Machine">
          <RolePlayer>
            <DomainClassMoniker Name="State" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="171525ed-3143-48ff-8285-fefad976dd08" Description="Description for Company.LanguageSm.StateMachineHasStates" Name="StateMachineHasStates" DisplayName="State Machine Has States" Namespace="Company.LanguageSm" IsEmbedding="true">
      <Source>
        <DomainRole Id="c9accdd8-ab7f-4dfd-b13f-ba5cb06f1bc5" Description="Description for Company.LanguageSm.StateMachineHasStates.StateMachine" Name="StateMachine" DisplayName="State Machine" PropertyName="States" PropagatesCopy="PropagatesCopyToLinkAndOppositeRolePlayer" PropertyDisplayName="States">
          <RolePlayer>
            <DomainClassMoniker Name="StateMachine" />
          </RolePlayer>
        </DomainRole>
      ...
      <Target>
        <DomainRole Id="593b202f-e731-40e5-b92d-f8eb186f851b" Description="Description for Company.LanguageSm.StateMachineHasStates.State" Name="State" DisplayName="State" PropertyName="StateMachine" Multiplicity="One" PropagatesDelete="true" PropertyDisplayName="State Machine">
          <RolePlayer>
            <DomainClassMoniker Name="State" />
          </RolePlayer>
        </DomainRole>
  ...
  <XmlSerializationBehavior Name="LanguageSmSerializationBehavior" Namespace="Company.LanguageSm">
    <ClassData>
      <XmlClassData TypeName="StateMachine" MonikerAttributeName="" SerializeId="true" MonikerElementName="stateMachineMoniker" ElementName="stateMachine" MonikerTypeName="StateMachineMoniker">
        <DomainClassMoniker Name="StateMachine" />
        <ElementData>
          <XmlRelationshipData UseFullForm="true" RoleElementName="initialState">
            <DomainRelationshipMoniker Name="StateMachineHasOneInitialState" />
          </XmlRelationshipData>
          <XmlRelationshipData UseFullForm="true" RoleElementName="states">
            <DomainRelationshipMoniker Name="StateMachineHasStates" />
          </XmlRelationshipData>
          <XmlPropertyData XmlName="name">
            <DomainPropertyMoniker Name="StateMachine/Name" />
          </XmlPropertyData>
          <XmlPropertyData XmlName="comment">
            <DomainPropertyMoniker Name="StateMachine/Comment" />
          </XmlPropertyData>
        </ElementData>
      </XmlClassData>
      ...
      <XmlClassData TypeName="StateMachineHasOneInitialState" MonikerAttributeName="" SerializeId="true" MonikerElementName="stateMachineHasOneInitialStateMoniker" ElementName="stateMachineHasOneInitialState" MonikerTypeName="StateMachineHasOneInitialStateMoniker">
        <DomainRelationshipMoniker Name="StateMachineHasOneInitialState" />
      </XmlClassData>
  ...
  <ConnectionBuilders>
    ...
    <ConnectionBuilder Name="StateMachineHasOneInitialStateBuilder">
      <LinkConnectDirective>
        <DomainRelationshipMoniker Name="StateMachineHasOneInitialState" />
        <SourceDirectives>
          <RolePlayerConnectDirective>
  ...
  <Designer CopyPasteGeneration="CopyPasteOnly" FileExtension="sm" EditorGuid="451916b3-5078-47ba-a516-765306cb7566">
    ...
    <ToolboxTab TabText="State Machine">
  ...
  <Explorer ExplorerGuid="a9a027ed-b71f-4c67-9f0c-fd886314c6b4" Title="State Machine Explorer">
